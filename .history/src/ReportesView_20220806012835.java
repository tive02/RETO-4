...
public class ReportesView {
    ...
    public void lideresQueMasGastan() {
        ...
        try {
            ...
            Statement stmt = null;
            ResultSet rs = null;
            String csql = "SELECT ID_Proyecto, sum (Cantidad*Precio_Unidad ) as VALOR FROM Proyecto JOIN MaterialConstruccion ON Compra.ID_MaterialConstruccion = MaterialConstruccion.ID_MaterialConstruccion JOIN Compra ON Proyecto.ID_Proyecto = Compra.ID_Proyecto WHERE Pagado = 'No' GROUP by Proyecto.ID_Proyecto HAVING sum (Cantidad*Precio_Unidad ) >50000 ORDER by VALOR DESC;  ";
            stmt = conn.createStatement();
            rs = stmt.executeQuery(csql);
